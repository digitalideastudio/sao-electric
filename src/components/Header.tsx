...
export default function Header({ isDark, setIsDark }: HeaderProps) {
  ...
  return (
    <header className="bg-[#c5d1f0]/65 backdrop-blur-sm dark:backdrop-blur-none sticky top-0 z-50 shadow-[0_3px_6px_0_rgba(0,0,0,0.2)] dark:shadow-[0_3px_6px_0_rgba(255,255,255,0.5)]">
