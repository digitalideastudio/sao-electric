          ...
          <div className="col-span-1">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-body-sm text-slate-600 dark:text-slate-700">+380 (99) 740 27 30</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4 text-slate-600 dark:text-slate-700" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-body-sm text-slate-600 dark:text-slate-700">saoelectric.ua@gmail.com</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4 text-slate-600 dark:text-slate-700" fill="currentColor" viewBox="0 0 20 20">
