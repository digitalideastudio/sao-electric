export default function Footer() {
  return (
    <footer className="bg-[#c5d1f0] text-slate-700 dark:text-slate-800 py-8 md:py-12 px-4">
          ...
          <div className="col-span-1">
            ...
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="text-body-sm text-slate-600 dark:text-slate-700">(555) 123-4567</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4 text-slate-600 dark:text-slate-700" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-body-sm text-slate-600 dark:text-slate-700">info@electricpro.com</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4 text-slate-600 dark:text-slate-700" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-body-sm text-slate-600 dark:text-slate-700">8:00 - 16:00</span>
              </div>
              <div className="flex justify-between">
