        ...
        <div className="flex items-center gap-16">
          ...
          <div className="flex-1 max-w-[600px]">
            <h1 className="text-hero font-bold text-slate-dark mb-6">
              S<span className="text-red">A</span>O <span className="text-electric-blue">Electric</span><br />
            ...
            <br/>Наша філософія проста: <span className="text-electric-blue">електрика має бути непомітною, але ідеально працювати</span>.
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-center gap-3">
                ...
                <span className="text-body text-slate-dark">Сертифіковані майстри KNX, Hager, AJAX</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 bg-electric-blue rounded-full flex items-center justify-center">
                  <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-body text-slate-dark">Акуратний монтаж та перевірена якість</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-5 h-5 bg-electric-blue rounded-full flex items-center justify-center">
                  <svg className="w-3 h-3 text-white" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-body text-slate-dark">Індивідуальні рішення для кожного об’єкта</span>
              </div>
            </div>
          ...
          <div className="flex-1 max-w-[600px] relative">
            <img src="/assets/hero-image.png" alt="Професійний електрик" className="w-full h-[800px] object-cover rounded-lg shadow-2xl" />
            {/* Experience Badge */}
