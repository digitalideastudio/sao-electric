    ...
    <div className="flex justify-center items-center w-full">
      <button className="relative list-none border-none bg-transparent rounded-full cursor-grab w-10 h-10 flex items-center justify-center p-0 m-0 transition-all duration-300 drop-shadow-[0_0_0_rgba(244,175,3,0)] group-hover:drop-shadow-[0_0_8px_rgba(244,175,3,0.6),0_0_16px_rgba(244,175,3,0.4)]">
        <svg 
          ...
          height="2.5em" 
          viewBox="0 0 384 512" 
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 transition-all duration-300 w-10 h-10 fill-[#5b9bd5] dark:fill-[#5b9bd5] group-hover:fill-[#f4af03]"
        >
        ...
        <svg 
          ...
          height="2.5em" 
          viewBox="0 0 384 512" 
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 fill-[#f4af03] opacity-0 transition-opacity duration-300 w-10 h-10 group-hover:opacity-100"
        >
